class OnePlayer extends Phaser.Scene {
    ...
    shipExplode(ship) {
        ...
        // display score with current score
...
class TwoPlayer extends Phaser.Scene {
    ...
    create() {
        ...
        // Display highscore text for both players
        scoreConfig.color = '#FFEB3B';
        this.add.text(borderUIsize + borderPadding * 2, borderUIsize + borderPadding * 2, 'Player01: ', scoreConfig);
        scoreConfig.color = '#843605';
        this.scoreLeft = this.add.text(borderUIsize + borderPadding * 7, borderUIsize + borderPadding * 2, this.p1Score, scoreConfig);

        this.add.text(borderUIsize + borderPadding * 17, borderUIsize + borderPadding * 2, 'HighScore: ', scoreConfig);
        this.scoreMid = this.add.text(borderUIsize + borderPadding * 34, borderUIsize + borderPadding * 2, this.highScore, scoreConfig);

        scoreConfig.color = '#F44336';
        this.add.text(borderUIsize + borderPadding * 44, borderUIsize + borderPadding * 2, 'Player02: ', scoreConfig);
        scoreConfig.color = '#843605';
        this.scoreRight = this.add.text(borderUIsize + borderPadding * 49, borderUIsize + borderPadding * 2, this.p2Score, scoreConfig);
